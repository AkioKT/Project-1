...
function orderButton1() {
    ...
    var img = document.createElement('img');
        img.src = 'Rendang.jpg'; // URL gambar
...
function orderButton2() {
    uncheckedOption();
    var img = document.createElement('img');
        img.src = 'mie celor sumatra.jpg'; // URL gambar
        img.alt = 'Gambar Placeholder';
        img.style.width = '17.5vw'; // Menentukan ukuran gambar
        document.getElementById('imageContainer').appendChild(img);
        checkedOption();
...
function orderButton4() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'bakmi jawa.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton7() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'kalimantan 1.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton8() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'kalimantan 2.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton9() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'kalimantan 3.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton10() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'sulawesi 1.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton11() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'sulawesi 2.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton12() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'sulawesi 3.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton13() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'papua 1.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton14() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'papua 2.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderButton15() {
    ...
    document.getElementById("cartList").setAttribute("style", "display: block;");
    var img = document.createElement('img');
    img.src = 'papua 3.jpg'; // URL gambar
    img.alt = 'Gambar Placeholder';
    img.style.width = '17.5vw'; // Menentukan ukuran gambar
    document.getElementById('imageContainer').appendChild(img);
    document.getElementById("outputFood").innerHTML = `Pesanan anda`;
...
function orderConfirm() {
    ...
    document.getElementById("orderMessage1").innerHTML = "Terima kasih telah memesan";
